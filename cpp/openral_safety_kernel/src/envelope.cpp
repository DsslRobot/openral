...
EnvelopeLoadStatus load_envelope_from_ros_parameters(rclcpp_lifecycle::LifecycleNode& node,
  ...
  out.max_ee_angular_speed_rad_s =
      node.get_parameter("max_ee_angular_speed_rad_s").as_double();
  ...
  out.gripper_min = node.get_parameter("gripper_min").as_double();
  out.gripper_max = node.get_parameter("gripper_max").as_double();
